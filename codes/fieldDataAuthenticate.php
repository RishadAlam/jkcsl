...
if (isset($_POST['totalChart']) && isset($_POST['fieldID']) && isset($_POST['centerID']) && isset($_POST['periodID']) && $_POST['totalChart'] == 1) {
    ...
    if ($_POST['fieldID'] != null) {
        ...
        $query = "SELECT SUM(deposit) AS totalSavings, 
                ...
                (SELECT COUNT(*) FROM loan_profiles WHERE field_id = $fieldID AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE())) AS totalLoanGiving,
                ...
                (SELECT SUM(withdrawal) FROM saving_withdrawals WHERE feild_id = $fieldID AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE())) AS totalSavingWithdraw,
                (SELECT SUM(withdrawal) FROM loan_savings_withdrawals WHERE feild_id = $fieldID AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE())) AS totalLoanSavingsWithdraw
        ...
        $query = "SELECT SUM(deposit) AS totalSavings, 
                ...
                (SELECT COUNT(*) FROM loan_profiles WHERE period_id = $periodID AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE())) AS totalLoanGiving,
                ...
                (SELECT SUM(withdrawal) FROM saving_withdrawals WHERE period_id = $periodID AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE())) AS totalSavingWithdraw,
                (SELECT SUM(withdrawal) FROM loan_savings_withdrawals WHERE period_id = $periodID AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE())) AS totalLoanSavingsWithdraw
        ...
        $query = "SELECT SUM(deposit) AS totalSavings, 
                ...
                (SELECT COUNT(*) FROM loan_profiles WHERE center_id = $centerID AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE())) AS totalLoanGiving,
                ...
                (SELECT SUM(withdrawal) FROM saving_withdrawals WHERE center_id = $centerID AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE())) AS totalSavingWithdraw,
                (SELECT SUM(withdrawal) FROM loan_savings_withdrawals WHERE center_id = $centerID AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE())) AS totalLoanSavingsWithdraw
...
if (isset($_POST['savingChart']) && isset($_POST['fieldID']) && isset($_POST['centerID']) && isset($_POST['periodID']) && $_POST['savingChart'] == 1) {
    if ($_POST['fieldID'] != null) {
        ...
        $query = "SELECT SUM(deposit) AS deposit, created_at_date FROM saving_collections WHERE feild_id = '${fieldID}'  AND period_id !='25' AND status = '1' AND MONTH(created_at_date) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE()) GROUP BY created_at_date";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['centerID'] != null) {
        $centerID = $_POST['centerID'];

        $query = "SELECT SUM(deposit) AS deposit, created_at_date FROM saving_collections WHERE center_id = '${centerID}'  AND period_id !='25' AND status = '1' AND MONTH(created_at_date) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE()) GROUP BY created_at_date";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['periodID'] != null) {
        $periodID = $_POST['periodID'];

        $query = "SELECT SUM(deposit) AS deposit, created_at_date FROM saving_collections WHERE period_id = '${periodID}' AND status = '1' AND MONTH(created_at_date) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE()) GROUP BY created_at_date";
...
if (isset($_POST['savingWithdrawalChart']) && isset($_POST['fieldID']) && isset($_POST['centerID']) && isset($_POST['periodID']) && $_POST['savingWithdrawalChart'] == 1) {
    if ($_POST['fieldID'] != null) {
        ...
        $query = "SELECT SUM(withdrawal) AS withdrawal, created_at FROM saving_withdrawals WHERE feild_id = '${fieldID}' AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) GROUP BY created_at";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['centerID'] != null) {
        $centerID = $_POST['centerID'];

        $query = "SELECT SUM(withdrawal) AS withdrawal, created_at FROM saving_withdrawals WHERE center_id = '${centerID}' AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) GROUP BY created_at";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['periodID'] != null) {
        $periodID = $_POST['periodID'];

        $query = "SELECT SUM(withdrawal) AS withdrawal, created_at FROM saving_withdrawals WHERE period_id = '${periodID}' AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) GROUP BY created_at";
...
if (isset($_POST['DPSChart']) && isset($_POST['fieldID']) && isset($_POST['centerID']) && $_POST['DPSChart'] == 1) {
    if ($_POST['fieldID'] != null) {
        ...
        $query = "SELECT SUM(deposit) AS DPS, created_at_date FROM saving_collections WHERE feild_id = '${fieldID}'  AND period_id ='25' AND status = '1' AND MONTH(created_at_date) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE()) GROUP BY created_at_date";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['centerID'] != null) {
        $centerID = $_POST['centerID'];

        $query = "SELECT SUM(deposit) AS DPS, created_at_date FROM saving_collections WHERE center_id = '${centerID}'  AND period_id ='25' AND status = '1' AND MONTH(created_at_date) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE()) GROUP BY created_at_date";
...
if (isset($_POST['loanChart']) && isset($_POST['fieldID']) && isset($_POST['centerID']) && isset($_POST['periodID']) && $_POST['loanChart'] == 1) {
    if ($_POST['fieldID'] != null) {
        ...
        $query = "SELECT SUM(loan) AS loan, created_at_date FROM loan_collections WHERE feild_id = '${fieldID}' AND status = '1' AND MONTH(created_at_date) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE()) GROUP BY created_at_date";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['centerID'] != null) {
        $centerID = $_POST['centerID'];

        $query = "SELECT SUM(loan) AS loan, created_at_date FROM loan_collections WHERE center_id = '${centerID}' AND status = '1' AND MONTH(created_at_date) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE()) GROUP BY created_at_date";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['periodID'] != null) {
        $periodID = $_POST['periodID'];

        $query = "SELECT SUM(loan) AS loan, created_at_date FROM loan_collections WHERE period_id = '${periodID}' AND status = '1' AND MONTH(created_at_date) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE()) GROUP BY created_at_date";
...
if (isset($_POST['loanSavingChart']) && isset($_POST['fieldID']) && isset($_POST['centerID']) && isset($_POST['periodID']) && $_POST['loanSavingChart'] == 1) {
    if ($_POST['fieldID'] != null) {
        ...
        $query = "SELECT SUM(deposit) AS loanDeposit, created_at_date FROM loan_collections WHERE feild_id = '${fieldID}' AND status = '1' AND MONTH(created_at_date) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE()) GROUP BY created_at_date";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['centerID'] != null) {
        $centerID = $_POST['centerID'];

        $query = "SELECT SUM(deposit) AS loanDeposit, created_at_date FROM loan_collections WHERE center_id = '${centerID}' AND status = '1' AND MONTH(created_at_date) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE()) GROUP BY created_at_date";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['periodID'] != null) {
        $periodID = $_POST['periodID'];

        $query = "SELECT SUM(deposit) AS loanDeposit, created_at_date FROM loan_collections WHERE period_id = '${periodID}' AND status = '1' AND MONTH(created_at_date) = MONTH(CURRENT_DATE()) AND YEAR(created_at_date) = YEAR(CURRENT_DATE()) GROUP BY created_at_date";
...
if (isset($_POST['loanSavingWithdrawChart']) && isset($_POST['fieldID']) && isset($_POST['centerID']) && isset($_POST['periodID']) && $_POST['loanSavingWithdrawChart'] == 1) {
    if ($_POST['fieldID'] != null) {
        ...
        $query = "SELECT SUM(withdrawal) AS loanWithdrawal, created_at FROM loan_savings_withdrawals WHERE feild_id = '${fieldID}' AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) GROUP BY created_at";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['centerID'] != null) {
        $centerID = $_POST['centerID'];

        $query = "SELECT SUM(withdrawal) AS loanWithdrawal, created_at FROM loan_savings_withdrawals WHERE center_id = '${centerID}' AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) GROUP BY created_at";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['periodID'] != null) {
        $periodID = $_POST['periodID'];

        $query = "SELECT SUM(withdrawal) AS loanWithdrawal, created_at FROM loan_savings_withdrawals WHERE period_id = '${periodID}' AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) GROUP BY created_at";
...
if (isset($_POST['clientAddChart']) && isset($_POST['fieldID']) && isset($_POST['centerID']) && isset($_POST['periodID']) && $_POST['clientAddChart'] == 1) {
    if ($_POST['fieldID'] != null) {
        ...
        $query = "SELECT COUNT(*) AS clientAdd, created_at FROM saving_profiles WHERE field_id = '${fieldID}' AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) GROUP BY created_at";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['centerID'] != null) {
        $centerID = $_POST['centerID'];

        $query = "SELECT COUNT(*) AS clientAdd, created_at FROM saving_profiles WHERE center_id = '${centerID}' AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) GROUP BY created_at";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['periodID'] != null) {
        $periodID = $_POST['periodID'];

        $query = "SELECT COUNT(*) AS clientAdd, created_at FROM saving_profiles WHERE period_id = '${periodID}' AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) GROUP BY created_at";
...
if (isset($_POST['savingsCloseChart']) && isset($_POST['fieldID']) && isset($_POST['centerID']) && isset($_POST['periodID']) && $_POST['savingsCloseChart'] == 1) {
    if ($_POST['fieldID'] != null) {
        ...
        $query = "SELECT COUNT(*) AS savingsClose, closing_at FROM saving_profiles WHERE field_id = '${fieldID}' AND status = '0' AND MONTH(closing_at) = MONTH(CURRENT_DATE()) AND YEAR(closing_at) = YEAR(CURRENT_DATE()) GROUP BY closing_at";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['centerID'] != null) {
        $centerID = $_POST['centerID'];

        $query = "SELECT COUNT(*) AS savingsClose, closing_at FROM saving_profiles WHERE center_id = '${centerID}' AND status = '0' AND MONTH(closing_at) = MONTH(CURRENT_DATE()) AND YEAR(closing_at) = YEAR(CURRENT_DATE()) GROUP BY closing_at";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['periodID'] != null) {
        $periodID = $_POST['periodID'];

        $query = "SELECT COUNT(*) AS savingsClose, closing_at FROM saving_profiles WHERE period_id = '${periodID}' AND status = '0' AND MONTH(closing_at) = MONTH(CURRENT_DATE()) AND YEAR(closing_at) = YEAR(CURRENT_DATE()) GROUP BY closing_at";
...
if (isset($_POST['loanCloseChart']) && isset($_POST['fieldID']) && isset($_POST['centerID']) && isset($_POST['periodID']) && $_POST['loanCloseChart'] == 1) {
    if ($_POST['fieldID'] != null) {
        ...
        $query = "SELECT COUNT(*) AS loanClose, closing_at FROM loan_profiles WHERE field_id = '${fieldID}' AND status = '0' AND MONTH(closing_at) = MONTH(CURRENT_DATE()) AND YEAR(closing_at) = YEAR(CURRENT_DATE()) GROUP BY closing_at";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['centerID'] != null) {
        $centerID = $_POST['centerID'];

        $query = "SELECT COUNT(*) AS loanClose, closing_at FROM loan_profiles WHERE center_id = '${centerID}' AND status = '0' AND MONTH(closing_at) = MONTH(CURRENT_DATE()) AND YEAR(closing_at) = YEAR(CURRENT_DATE()) GROUP BY closing_at";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['periodID'] != null) {
        $periodID = $_POST['periodID'];

        $query = "SELECT COUNT(*) AS loanClose, closing_at FROM loan_profiles WHERE period_id = '${periodID}' AND status = '0' AND MONTH(closing_at) = MONTH(CURRENT_DATE()) AND YEAR(closing_at) = YEAR(CURRENT_DATE()) GROUP BY closing_at";
...
if (isset($_POST['loanGvingChart']) && isset($_POST['fieldID']) && isset($_POST['centerID']) && isset($_POST['periodID']) && $_POST['loanGvingChart'] == 1) {
    if ($_POST['fieldID'] != null) {
        ...
        $query = "SELECT COUNT(*) AS loanGving, created_at FROM loan_profiles WHERE field_id = '${fieldID}' AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) GROUP BY created_at";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['centerID'] != null) {
        $centerID = $_POST['centerID'];

        $query = "SELECT COUNT(*) AS loanGving, created_at FROM loan_profiles WHERE center_id = '${centerID}' AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) GROUP BY created_at";

        $result = $fields->fieldCardsLoad($query);
    } elseif ($_POST['periodID'] != null) {
        $periodID = $_POST['periodID'];

        $query = "SELECT COUNT(*) AS loanGving, created_at FROM loan_profiles WHERE period_id = '${periodID}' AND status = '1' AND MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) GROUP BY created_at";
