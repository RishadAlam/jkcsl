...
$query = "SELECT name AS loanOfficer, SUM(l.deposit) AS savings, SUM(l.loan) AS loan, SUM(l.interest) AS interest, SUM(l.total) AS total FROM loan_collections AS l INNER JOIN users AS u ON l.officers_id = u.id WHERE l.created_at_date = CURRENT_DATE";
if ($officer_id != null) {
