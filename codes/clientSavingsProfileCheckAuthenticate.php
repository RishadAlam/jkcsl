...
$query = "SELECT balance, next_check_date, checked_at AS date FROM savings_acc_checks WHERE saving_profiles_id ='${savingsID}' AND checked_at BETWEEN '${from_date}' AND '${end_date}'";
