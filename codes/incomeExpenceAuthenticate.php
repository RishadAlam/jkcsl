...
if (isset($_POST['total_expence']) && isset($_POST['from_date']) && isset($_POST['from_date']) && isset($_POST['type'])) {
    ...
    if ($type == 'all') {
        $query = "SELECT NVL(SUM(expence),0) AS expence, '1' AS type FROM expenses WHERE type = '1' AND date BETWEEN '${from_date}' AND '${end_date}'
    UNION ALL
    SELECT NVL(SUM(expence),0) AS expence, '2' AS type FROM expenses WHERE type = '2' AND date BETWEEN '${from_date}' AND '${end_date}'
    UNION ALL
    SELECT NVL(SUM(expence),0) AS expence, '3' AS type FROM expenses WHERE type = '3' AND date BETWEEN '${from_date}' AND '${end_date}'
    UNION ALL
    SELECT NVL(SUM(expence),0) AS expence, '4' AS type FROM expenses WHERE type = '4' AND date BETWEEN '${from_date}' AND '${end_date}'";
    } elseif ($type == 1) {
        $query = "SELECT NVL(SUM(expence),0) AS expence, '1' AS type FROM expenses WHERE type = '1' AND date BETWEEN '${from_date}' AND '${end_date}'
        UNION ALL
        ...
        $query = "SELECT NVL(SUM(expence),0) AS expence, '2' AS type FROM expenses WHERE type = '2' AND date BETWEEN '${from_date}' AND '${end_date}'
        UNION ALL
        ...
        $query = "SELECT NVL(SUM(expence),0) AS expence, '3' AS type FROM expenses WHERE type = '3' AND date BETWEEN '${from_date}' AND '${end_date}'
        UNION ALL
        SELECT 0 AS expence, '1' AS type
        UNION ALL
        SELECT 0 AS expence, '2' AS type
        ...
        $query = "SELECT NVL(SUM(expence),0) AS expence, '4' AS type FROM expenses WHERE type = '4' AND date BETWEEN '${from_date}' AND '${end_date}'
        UNION ALL
        SELECT 0 AS expence, '1' AS type
        UNION ALL
        SELECT 0 AS expence, '2' AS type
...
if (isset($_POST['expanceChart']) && isset($_POST['from_date']) && isset($_POST['end_date']) && isset($_POST['type'])) {
    ...
    if ($type == 'all') {
        $query = "SELECT NVL(SUM(daily_expence),0) AS daily_expence, NVL(SUM(fdr_expence),0) AS fdr_expence, NVL(SUM(salery_expence),0) AS salery_expence, NVL(SUM(closing_expence),0) AS closing_expence, date FROM (
        ...
        $query = "SELECT NVL(SUM(expence),0) AS daily_expence, 0 AS fdr_expence, 0 AS salery_expence, 0 AS closing_expence, DATE_FORMAT(date, '%d-%m-%Y') AS date FROM expenses WHERE type = '1' AND date BETWEEN '${from_date}' AND '${end_date}' GROUP BY date";
    } elseif ($type == 2) {
        $query = "SELECT NVL(SUM(expence),0) AS fdr_expence, 0 AS daily_expence, 0 AS salery_expence, 0 AS closing_expence, DATE_FORMAT(date, '%d-%m-%Y') AS date FROM expenses WHERE type = '2' AND date BETWEEN '${from_date}' AND '${end_date}' GROUP BY date";
    } elseif ($type == 3) {
        $query = "SELECT NVL(SUM(expence),0) AS salery_expence, 0 AS daily_expence, 0 AS fdr_expence, 0 AS closing_expence, DATE_FORMAT(date, '%d-%m-%Y') AS date FROM expenses WHERE type = '3' AND date BETWEEN '${from_date}' AND '${end_date}' GROUP BY date";
    } elseif ($type == 4) {
        $query = "SELECT NVL(SUM(expence),0) AS closing_expence, 0 AS daily_expence, 0 AS salery_expence, 0 AS fdr_expence, DATE_FORMAT(date, '%d-%m-%Y') AS date FROM expenses WHERE type = '4' AND date BETWEEN '${from_date}' AND '${end_date}' GROUP BY date";
    }
    // echo json_encode($query);
    // die();
    $result = $collection->incomeExpanceRecordload($query);
...
if (isset($_POST['newLoanCloseLoan']) && isset($_POST['from_date']) && isset($_POST['end_date']) && isset($_POST['field']) && isset($_POST['center']) && isset($_POST['period']) && isset($_POST['officer'])) {
    ...
    if ($field == null && $center == null && $officer == null && $period == null) {
        $query = "SELECT NVL(SUM(loanGiving),0) AS loanGiving, NVL(SUM(loanClose),0) AS loanClose FROM( SELECT COUNT(*) AS loanGiving, 0 AS loanClose FROM loan_profiles WHERE created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS loanGiving, COUNT(*) AS loanClose FROM loan_profiles WHERE closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center == null && $officer == null && $period == null) {
        $query = "SELECT NVL(SUM(loanGiving),0) AS loanGiving, NVL(SUM(loanClose),0) AS loanClose FROM( SELECT COUNT(*) AS loanGiving, 0 AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS loanGiving, COUNT(*) AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center != null && $officer == null && $period == null) {
        $query = "SELECT NVL(SUM(loanGiving),0) AS loanGiving, NVL(SUM(loanClose),0) AS loanClose FROM( SELECT COUNT(*) AS loanGiving, 0 AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS loanGiving, COUNT(*) AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center != null && $officer != null && $period == null) {
        $query = "SELECT NVL(SUM(loanGiving),0) AS loanGiving, NVL(SUM(loanClose),0) AS loanClose FROM( SELECT COUNT(*) AS loanGiving, 0 AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND reg_officer_id = '${officer}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS loanGiving, COUNT(*) AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND reg_officer_id = '${officer}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center != null && $officer != null && $period != null) {
        $query = "SELECT NVL(SUM(loanGiving),0) AS loanGiving, NVL(SUM(loanClose),0) AS loanClose FROM( SELECT COUNT(*) AS loanGiving, 0 AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND reg_officer_id = '${officer}' AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS loanGiving, COUNT(*) AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND reg_officer_id = '${officer}' AND period_id = '${period}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field == null && $center == null && $officer == null && $period != null) {
        $query = "SELECT NVL(SUM(loanGiving),0) AS loanGiving, NVL(SUM(loanClose),0) AS loanClose FROM( SELECT COUNT(*) AS loanGiving, 0 AS loanClose FROM loan_profiles WHERE period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS loanGiving, COUNT(*) AS loanClose FROM loan_profiles WHERE period_id = '${period}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field == null && $center == null && $officer != null && $period != null) {
        $query = "SELECT NVL(SUM(loanGiving),0) AS loanGiving, NVL(SUM(loanClose),0) AS loanClose FROM( SELECT COUNT(*) AS loanGiving, 0 AS loanClose FROM loan_profiles WHERE reg_officer_id = '${officer}' AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS loanGiving, COUNT(*) AS loanClose FROM loan_profiles WHERE reg_officer_id = '${officer}' AND period_id = '${period}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center == null && $officer != null && $period != null) {
        $query = "SELECT NVL(SUM(loanGiving),0) AS loanGiving, NVL(SUM(loanClose),0) AS loanClose FROM( SELECT COUNT(*) AS loanGiving, 0 AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND reg_officer_id = '${officer}' AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS loanGiving, COUNT(*) AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND reg_officer_id = '${officer}' AND period_id = '${period}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center != null && $officer == null && $period != null) {
        $query = "SELECT NVL(SUM(loanGiving),0) AS loanGiving, NVL(SUM(loanClose),0) AS loanClose FROM( SELECT COUNT(*) AS loanGiving, 0 AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS loanGiving, COUNT(*) AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND period_id = '${period}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center == null && $officer == null && $period != null) {
        $query = "SELECT NVL(SUM(loanGiving),0) AS loanGiving, NVL(SUM(loanClose),0) AS loanClose FROM( SELECT COUNT(*) AS loanGiving, 0 AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS loanGiving, COUNT(*) AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND period_id = '${period}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field == null && $center == null && $officer != null && $period == null) {
        $query = "SELECT NVL(SUM(loanGiving),0) AS loanGiving, NVL(SUM(loanClose),0) AS loanClose FROM( SELECT COUNT(*) AS loanGiving, 0 AS loanClose FROM loan_profiles WHERE reg_officer_id = '${officer}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS loanGiving, COUNT(*) AS loanClose FROM loan_profiles WHERE reg_officer_id = '${officer}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center == null && $officer != null && $period == null) {
        $query = "SELECT NVL(SUM(loanGiving),0) AS loanGiving, NVL(SUM(loanClose),0) AS loanClose FROM( SELECT COUNT(*) AS loanGiving, 0 AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND  reg_officer_id = '${officer}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS loanGiving, COUNT(*) AS loanClose FROM loan_profiles WHERE field_id = '${field}' AND  reg_officer_id = '${officer}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    }
    // echo json_encode($query);
    // die();
    $result = $collection->incomeExpanceRecordload($query);
...
if (isset($_POST['addCloseSavings']) && isset($_POST['from_date']) && isset($_POST['end_date']) && isset($_POST['field']) && isset($_POST['center']) && isset($_POST['period']) && isset($_POST['officer'])) {
    ...
    if ($field == null && $center == null && $officer == null && $period == null) {
        $query = "SELECT NVL(SUM(newSavings),0) AS newSavings, NVL(SUM(closeSavings),0) AS closeSavings FROM( SELECT COUNT(*) AS newSavings, 0 AS closeSavings FROM saving_profiles WHERE created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS newSavings, COUNT(*) AS closeSavings FROM saving_profiles WHERE closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center == null && $officer == null && $period == null) {
        $query = "SELECT NVL(SUM(newSavings),0) AS newSavings, NVL(SUM(closeSavings),0) AS closeSavings FROM( SELECT COUNT(*) AS newSavings, 0 AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS newSavings, COUNT(*) AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center != null && $officer == null && $period == null) {
        $query = "SELECT NVL(SUM(newSavings),0) AS newSavings, NVL(SUM(closeSavings),0) AS closeSavings FROM( SELECT COUNT(*) AS newSavings, 0 AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS newSavings, COUNT(*) AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center != null && $officer != null && $period == null) {
        $query = "SELECT NVL(SUM(newSavings),0) AS newSavings, NVL(SUM(closeSavings),0) AS closeSavings FROM( SELECT COUNT(*) AS newSavings, 0 AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND reg_officer_id = '${officer}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS newSavings, COUNT(*) AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND reg_officer_id = '${officer}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center != null && $officer != null && $period != null) {
        $query = "SELECT NVL(SUM(newSavings),0) AS newSavings, NVL(SUM(closeSavings),0) AS closeSavings FROM( SELECT COUNT(*) AS newSavings, 0 AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND reg_officer_id = '${officer}' AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS newSavings, COUNT(*) AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND reg_officer_id = '${officer}' AND period_id = '${period}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field == null && $center == null && $officer == null && $period != null) {
        $query = "SELECT NVL(SUM(newSavings),0) AS newSavings, NVL(SUM(closeSavings),0) AS closeSavings FROM( SELECT COUNT(*) AS newSavings, 0 AS closeSavings FROM saving_profiles WHERE period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS newSavings, COUNT(*) AS closeSavings FROM saving_profiles WHERE period_id = '${period}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field == null && $center == null && $officer != null && $period != null) {
        $query = "SELECT NVL(SUM(newSavings),0) AS newSavings, NVL(SUM(closeSavings),0) AS closeSavings FROM( SELECT COUNT(*) AS newSavings, 0 AS closeSavings FROM saving_profiles WHERE reg_officer_id = '${officer}' AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS newSavings, COUNT(*) AS closeSavings FROM saving_profiles WHERE reg_officer_id = '${officer}' AND period_id = '${period}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center == null && $officer != null && $period != null) {
        $query = "SELECT NVL(SUM(newSavings),0) AS newSavings, NVL(SUM(closeSavings),0) AS closeSavings FROM( SELECT COUNT(*) AS newSavings, 0 AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND reg_officer_id = '${officer}' AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS newSavings, COUNT(*) AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND reg_officer_id = '${officer}' AND period_id = '${period}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center != null && $officer == null && $period != null) {
        $query = "SELECT NVL(SUM(newSavings),0) AS newSavings, NVL(SUM(closeSavings),0) AS closeSavings FROM( SELECT COUNT(*) AS newSavings, 0 AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS newSavings, COUNT(*) AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND center_id = '${center}' AND period_id = '${period}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center == null && $officer == null && $period != null) {
        $query = "SELECT NVL(SUM(newSavings),0) AS newSavings, NVL(SUM(closeSavings),0) AS closeSavings FROM( SELECT COUNT(*) AS newSavings, 0 AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS newSavings, COUNT(*) AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND period_id = '${period}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field == null && $center == null && $officer != null && $period == null) {
        $query = "SELECT NVL(SUM(newSavings),0) AS newSavings, NVL(SUM(closeSavings),0) AS closeSavings FROM( SELECT COUNT(*) AS newSavings, 0 AS closeSavings FROM saving_profiles WHERE reg_officer_id = '${officer}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS newSavings, COUNT(*) AS closeSavings FROM saving_profiles WHERE reg_officer_id = '${officer}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    } elseif ($field != null && $center == null && $officer != null && $period == null) {
        $query = "SELECT NVL(SUM(newSavings),0) AS newSavings, NVL(SUM(closeSavings),0) AS closeSavings FROM( SELECT COUNT(*) AS newSavings, 0 AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND  reg_officer_id = '${officer}' AND created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS newSavings, COUNT(*) AS closeSavings FROM saving_profiles WHERE field_id = '${field}' AND  reg_officer_id = '${officer}' AND closing_at BETWEEN '${from_date}' AND '${end_date}' ) AS a";
    }
    // echo json_encode($query);
    // die();
    $result = $collection->incomeExpanceRecordload($query);
...
if (isset($_POST['savingsAnalytics']) && isset($_POST['from_date']) && isset($_POST['end_date']) && isset($_POST['field']) && isset($_POST['center']) && isset($_POST['period']) && isset($_POST['officer'])) {
    ...
    if ($field == null && $center == null && $officer == null && $period == null) {
        ...
        $query = "SELECT NVL(SUM(deposit),0) as deposit, NVL(SUM(withdrawal),0) as withdrawal FROM (SELECT SUM(deposit) as deposit, 0 as withdrawal FROM saving_collections WHERE created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 as deposit, SUM(withdrawal) as withdrawal FROM saving_withdrawals WHERE created_at BETWEEN '${from_date}' AND '${end_date}') AS a";
    } elseif ($field != null && $center == null && $officer == null && $period == null) {

        $query = "SELECT NVL(SUM(deposit),0) as deposit, NVL(SUM(withdrawal),0) as withdrawal FROM (SELECT SUM(deposit) as deposit, 0 as withdrawal FROM saving_collections WHERE feild_id = ${field} AND created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 as deposit, SUM(withdrawal) as withdrawal FROM saving_withdrawals WHERE feild_id = ${field} AND created_at BETWEEN '${from_date}' AND '${end_date}') AS a";
    } elseif ($field != null && $center != null && $officer == null && $period == null) {

        $query = "SELECT NVL(SUM(deposit),0) as deposit, NVL(SUM(withdrawal),0) as withdrawal FROM (SELECT SUM(deposit) as deposit, 0 as withdrawal FROM saving_collections WHERE feild_id = ${field} AND center_id= ${center} AND created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 as deposit, SUM(withdrawal) as withdrawal FROM saving_withdrawals WHERE feild_id = ${field} AND center_id= ${center} AND created_at BETWEEN '${from_date}' AND '${end_date}') AS a";
    } elseif ($field != null && $center != null && $officer != null && $period == null) {

        $query = "SELECT NVL(SUM(deposit),0) as deposit, NVL(SUM(withdrawal),0) as withdrawal FROM (SELECT SUM(deposit) as deposit, 0 as withdrawal FROM saving_collections WHERE feild_id = ${field} AND center_id= ${center} AND officers_id = ${officer} AND created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 as deposit, SUM(withdrawal) as withdrawal FROM saving_withdrawals WHERE feild_id = ${field} AND center_id= ${center} AND officers_id = ${officer} AND created_at BETWEEN '${from_date}' AND '${end_date}') AS a";
    } elseif ($field != null && $center != null && $officer != null && $period != null) {

        $query = "SELECT NVL(SUM(deposit),0) as deposit, NVL(SUM(withdrawal),0) as withdrawal FROM (SELECT SUM(deposit) as deposit, 0 as withdrawal FROM saving_collections WHERE feild_id = ${field} AND center_id= ${center} AND officers_id = ${officer} AND period_id = '${period}' AND created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 as deposit, SUM(withdrawal) as withdrawal FROM saving_withdrawals WHERE feild_id = ${field} AND center_id= ${center} AND officers_id = ${officer} AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}') AS a";
    } elseif ($field == null && $center == null && $officer == null && $period != null) {

        $query = "SELECT NVL(SUM(deposit),0) as deposit, NVL(SUM(withdrawal),0) as withdrawal FROM (SELECT SUM(deposit) as deposit, 0 as withdrawal FROM saving_collections WHERE period_id = '${period}' AND created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 as deposit, SUM(withdrawal) as withdrawal FROM saving_withdrawals WHERE period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}') AS a";
    } elseif ($field == null && $center == null && $officer != null && $period != null) {

        $query = "SELECT NVL(SUM(deposit),0) as deposit, NVL(SUM(withdrawal),0) as withdrawal FROM (SELECT SUM(deposit) as deposit, 0 as withdrawal FROM saving_collections WHERE officers_id = ${officer} AND period_id = '${period}' AND created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 as deposit, SUM(withdrawal) as withdrawal FROM saving_withdrawals WHERE officers_id = ${officer} AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}') AS a";
    } elseif ($field != null && $center == null && $officer != null && $period != null) {

        $query = "SELECT NVL(SUM(deposit),0) as deposit, NVL(SUM(withdrawal),0) as withdrawal FROM (SELECT SUM(deposit) as deposit, 0 as withdrawal FROM saving_collections WHERE feild_id = ${field} AND officers_id = ${officer} AND period_id = '${period}' AND created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 as deposit, SUM(withdrawal) as withdrawal FROM saving_withdrawals WHERE feild_id = ${field} AND officers_id = ${officer} AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}') AS a";
    } elseif ($field != null && $center != null && $officer == null && $period != null) {

        $query = "SELECT NVL(SUM(deposit),0) as deposit, NVL(SUM(withdrawal),0) as withdrawal FROM (SELECT SUM(deposit) as deposit, 0 as withdrawal FROM saving_collections WHERE feild_id = ${field} AND center_id= ${center} AND period_id = '${period}' AND created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 as deposit, SUM(withdrawal) as withdrawal FROM saving_withdrawals WHERE feild_id = ${field} AND center_id= ${center} AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}') AS a";
    } elseif ($field != null && $center == null && $officer == null && $period != null) {

        $query = "SELECT NVL(SUM(deposit),0) as deposit, NVL(SUM(withdrawal),0) as withdrawal FROM (SELECT SUM(deposit) as deposit, 0 as withdrawal FROM saving_collections WHERE feild_id = ${field} AND period_id = '${period}' AND created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 as deposit, SUM(withdrawal) as withdrawal FROM saving_withdrawals WHERE feild_id = ${field} AND period_id = '${period}' AND created_at BETWEEN '${from_date}' AND '${end_date}') AS a";
    } elseif ($field == null && $center == null && $officer != null && $period == null) {

        $query = "SELECT NVL(SUM(deposit),0) as deposit, NVL(SUM(withdrawal),0) as withdrawal FROM (SELECT SUM(deposit) as deposit, 0 as withdrawal FROM saving_collections WHERE officers_id = ${officer} AND created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 as deposit, SUM(withdrawal) as withdrawal FROM saving_withdrawals WHERE officers_id = ${officer} AND created_at BETWEEN '${from_date}' AND '${end_date}') AS a";
    } elseif ($field != null && $center == null && $officer != null && $period == null) {

        $query = "SELECT NVL(SUM(deposit),0) as deposit, NVL(SUM(withdrawal),0) as withdrawal FROM (SELECT SUM(deposit) as deposit, 0 as withdrawal FROM saving_collections WHERE feild_id = ${field} AND officers_id = ${officer} AND created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 as deposit, SUM(withdrawal) as withdrawal FROM saving_withdrawals WHERE feild_id = ${field} AND officers_id = ${officer} AND created_at BETWEEN '${from_date}' AND '${end_date}') AS a";
    }
    // echo json_encode($query);
    // die();
    $result = $collection->incomeExpanceRecordload($query);
...
if (isset($_POST['accountCalculationAnalytics']) && isset($_POST['from_date']) && isset($_POST['end_date'])) {
    ...
    $query = "SELECT NVL(SUM(income),0) AS income, NVL(SUM(interest),0) AS interest, NVL(SUM(expence),0) AS expence, NVL((NVL(SUM(income),0)+NVL(SUM(interest),0))-NVL(SUM(expence),0),0) AS result FROM( SELECT NVL(SUM(income),0) AS income, 0 AS interest, 0 AS expence FROM incomes WHERE created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS income, NVL(SUM(interest),0) AS interest, 0 AS expence FROM loan_collections WHERE created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS income, 0 AS interest, NVL(SUM(expence),0) AS expence FROM expenses WHERE created_at BETWEEN '${from_date}' AND '${end_date}') AS a";
...
if (isset($_POST['accountCalculationAnalyticsChart']) && isset($_POST['from_date']) && isset($_POST['end_date'])) {
    ...
    $query = "SELECT NVL(SUM(income),0) AS income, NVL(SUM(interest),0) AS interest, NVL(SUM(expence),0) AS expence, NVL((NVL(SUM(income),0)+NVL(SUM(interest),0))-NVL(SUM(expence),0),0) AS result, date FROM( SELECT NVL(income,0) AS income, 0 AS interest, 0 AS expence, DATE_FORMAT(created_at, '%d-%m-%Y') AS date FROM incomes WHERE created_at BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS income, NVL(interest,0) AS interest, 0 AS expence, DATE_FORMAT(created_at_date, '%d-%m-%Y') AS date FROM loan_collections WHERE created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS income, 0 AS interest, NVL(expence,0) AS expence, DATE_FORMAT(created_at, '%d-%m-%Y') AS date FROM expenses WHERE created_at BETWEEN '${from_date}' AND '${end_date}') AS a GROUP BY date";
...
if (isset($_POST['expenceCalculationAnalytics']) && isset($_POST['from_date']) && isset($_POST['end_date'])) {
    ...
    $query = "SELECT NVL(SUM(expence),0) AS expence, 
                CASE
...
if (isset($_POST['incomeCalculationAnalytics']) && isset($_POST['from_date']) && isset($_POST['end_date'])) {
    ...
    $query = "SELECT NVL(SUM(income),0) AS income, details FROM incomes WHERE created_at BETWEEN '${from_date}' AND '${end_date}' GROUP BY details";
...
if (isset($_POST['interestCalculationAnalytics']) && isset($_POST['from_date']) && isset($_POST['end_date'])) {
    ...
    $query = "SELECT NVL(SUM(l.interest),0) AS interest, p.period_name FROM loan_collections AS l INNER JOIN periods AS p ON p.period_id = l.period_id WHERE l.created_at_date BETWEEN '${from_date}' AND '${end_date}' GROUP BY l.period_id";
...
if (isset($_POST['finalCalculationAnalytics']) && isset($_POST['from_date']) && isset($_POST['end_date'])) {
    ...
    $query = "SELECT NVL(SUM(interest)+SUM(income),0) AS tk, 'সর্বমোট আয়' AS name FROM (SELECT NVL(SUM(interest),0) AS interest, 0 AS income FROM loan_collections WHERE created_at_date BETWEEN '${from_date}' AND '${end_date}' UNION ALL SELECT 0 AS interest, NVL(SUM(income),0) AS income FROM incomes WHERE created_at BETWEEN '${from_date}' AND '${end_date}' ) AS b UNION ALL SELECT NVL(SUM(expence),0) AS tk, 'সর্বমোট খরচ' AS name FROM expenses WHERE created_at BETWEEN '${from_date}' AND '${end_date}'";
