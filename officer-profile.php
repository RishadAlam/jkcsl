                ...
                <div class="recent_collection">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-loan" role="tabpanel" aria-labelledby="nav-loan-tab">
                            ...
                            <table id="loan_collection_list" class="w-100 table table-responsive table-bordered table-hover table-striped  text-start">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>সদস্য</th>
                        ...
                        <div class="tab-pane fade show" id="nav-loan-saving-withdrawal" role="tabpanel" aria-labelledby="nav-loan-saving-withdrawal-tab">
                            ...
                            <table id="loan_collection_withdrawal_list" class="w-100 table table-responsive table-bordered table-hover table-striped text-start">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>সদস্য</th>
                        ...
                        <div class="tab-pane fade" id="nav-loan-giving" role="tabpanel" aria-labelledby="nav-loan-giving-tab">
                            ...
                            <table id="loan_giving_list" class="w-100 table table-responsive table-bordered table-hover table-striped text-start">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>সদস্য</th>
                        ...
                        <div class="tab-pane fade" id="nav-client-add" role="tabpanel" aria-labelledby="nav-client-add-tab">
                            ...
                            <table id="client_add_list" class="w-100 table table-responsive table-bordered table-hover table-striped text-start">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>সদস্য</th>
