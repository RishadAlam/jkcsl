            ...
            <div class="col-lg-12 row px-3">
                <div class="col-md-6 ps-md-0">
                    <div class="recent_collection">
                        ...
                        <table id="savings_withdrawal_table" class="table table-bordered table-responsive table-hover table-striped" style="width:100%;">
                            <thead>
                                <tr>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="6" class="text-end" style="border-top: 1px solid #fff;">সর্বমোট</td>
                ...
                <div class="col-md-6 pe-md-0">
                    <div class="recent_collection">
                        ...
                        <table id="loan_savings_withdrawal_table" class="table table-bordered table-responsive table-hover table-striped" style="width:100%;">
                            <thead>
                                <tr>
                                    <th style="max-width: 2%;">#</th>
                                    <th style="max-width: 10%;">সদস্য</th>
                ...
                <div class="col-md-6 ps-md-0">
                    <div class="recent_collection">
                        ...
                        <table id="officers_savings_collection" class="table table-bordered table-responsive table-hover table-striped" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>অফিসার</th>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="2" class="text-end" style="border-top: 1px solid #fff;">সর্বমোট</td>
                ...
                <div class="col-md-6 pe-md-0">
                    <div class="recent_collection">
                        ...
                        <table id="officers_loan_collection" class="table table-bordered table-responsive table-hover table-striped" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>অফিসার</th>
